...
export const BEATEN_TO_WORD = 'You were beaten to spell the word';
...
export const FATAL_ERROR = 'A Fatal error has occurred at the opponent\'s side game can no longer resume';
...
export const BEATEN_TO_WORD_CODE = 14;
...
export const FATAL_ERROR_CODE = 60;
